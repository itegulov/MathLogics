...
public interface Deductor<E extends Expression<E>> {
     ...
     * contains {@link ru.ifmo.ctddev.itegulov.mathlogic.proof.Statement}, that can be trusted to be true.
     * <p>
     ...
     * Assumes, that {@code proofed} contains {@link ru.ifmo.ctddev.itegulov.mathlogic.proof.Statement}, that
     ...
     * Assumes, that {@code proofed} contains {@link ru.ifmo.ctddev.itegulov.mathlogic.proof.Statement}, that can
